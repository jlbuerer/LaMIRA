...
sub findCircles {
    ...
    $group =~ /(.+).txt/;
    $fhout = $self->{_outdir}."/".$1."_circles.txt";
    $fhoverlap = $self->{_outdir}."/".$1."_circles_overlap.txt";
    $fhgap = $self->{_outdir}."/".$1."_circles_gap.txt";
    $fh = $self->{_outdir}."/".$group;
    open (FH, $fh) or die $!;
    open (FHout,">$fhout") or die $!;
    open (FHoutoverlap, ">$fhoverlap") or die $!;
    ...
    while (<FH>){
        ...
        if ((length($seq)) == ((length($headseq))+(length($tailseq)))){
            ...
            $circleflag = 0;
            #if (($ss_coord[1][0]==$headcoord2)&&($ss_coord[6][0]==$tailcoord1)&&($readstrand eq "+")&&($ss_coord[1][1] ne undef)&&($ss_coord[6][1] ne undef)){
            #    $circleflag = 1;
            #}
            #elsif (($ss_coord[5][0]==$headcoord2)&&($ss_coord[2][0]==$tailcoord2)&&($readstrand eq "-")&&($ss_coord[5][1] ne undef)&&($ss_coord[2][1] ne undef)){
            #    $circleflag = 1;
            #}
            #elsif (($ss_coord[1][0]==$headcoord2)&&($ss_coord[6][0]==$tailcoord1)&&($readstrand eq "-")&&($ss_coord[1][1] ne undef)&&($ss_coord[6][1] ne undef)){
            #    $circleflag = 1;
            #}
            #elsif (($ss_coord[5][0] ==$headcoord1)&&($ss_coord[2][0]==$tailcoord2)&&($readstrand eq "+")&&($ss_coord[5][1] ne undef)&&($ss_coord[2][1] ne undef)){
            #    $circleflag = 1;
            #}
            ...
            elsif (($ss_coord[1][0]==$headcoord2)&&($ss_coord[6][0]==$tailcoord1)&&($readstrand eq "-")&&($ss_coord[2][1] ne undef)&&($ss_coord[12][1] ne undef)){
                $circleflag = 1;
            }
            elsif (($ss_coord[5][0]==$headcoord2)&&($ss_coord[2][0]==$tailcoord1)&&($readstrand eq "-")&&($ss_coord[5][1] ne undef)&&($ss_coord[2][1] ne undef)){
                $circleflag = 1;
            }
            elsif (($ss_coord[5][0] ==$headcoord2)&&($ss_coord[2][0]==$tailcoord1)&&($readstrand eq "+")&&($ss_coord[5][1] ne undef)&&($ss_coord[2][1] ne undef)){
                $circleflag = 1;
        ...
        #overlapped alignment
            ...
            $circleflag = 0;
            if ((abs($ss_coord[1][0]-$headcoord2)<=$overlap)&&($sscoord[1][0]<=$headcoord2)&&(abs($ss_coord[6][0]-$tailcoord1)<=$overlap)&&($sscoord[6][0]>=$tailcoord1)&&($readstrand eq "+")&&($ss_coord[1][1] ne undef)&&($ss_coord[6][1] ne undef)){
                $circleflag = 1;
            }
            elsif ((abs($ss_coord[1][0]-$headcoord2)<=$overlap)&&($ss_coord[1][0]>=$headcoord2)&&(abs($ss_coord[6][0]-$tailcoord1)<=$overlap)&&($ss_coord[6][0]<=$tailcoord1)&&($readstrand eq "-")&&($ss_coord[1][1] ne undef)&&($ss_coord[6][1] ne undef)){
                $circleflag = 1;
                $circleflag = 1;
            }
            elsif ((abs($ss_coord[5][0]-$headcoord2)<=$overlap)&&($ss_coord[5][0]>=$headcoord2)&&(abs($ss_coord[2][0]-$tailcoord1)<=$overlap)&&($ss_coord[2][0]<=$tailcoord1)&&($readstrand eq "-")&&($ss_coord[5][1] ne undef)&&($ss_coord[2][1] ne undef)){
                $circleflag = 1;
                $circleflag = 1;
            }
            elsif ((abs($ss_coord[5][0]-$headcoord2)<=$overlap)&&($ss_coord[5][0]<=$headcoord2)&&(abs($ss_coord[2][0]-$tailcoord1)<=$overlap)&&($ss_coord[2][0]>=$tailcoord1)&&($readstrand eq "+")&&($ss_coord[5][1] ne undef)&&($ss_coord[2][1] ne undef)){
        ...
        #gapped alignment
            ...
            $circleflag = 0;
            if ((abs($ss_coord[1][0]-$headcoord2)<=$gap)&&(abs($ss_coord[6][0]-$tailcoord1)<=$gap)&&($readstrand eq "+")&&($ss_coord[1][1] ne undef)&&($ss_coord[6][1] ne undef)){
                $circleflag = 1;
            }
            elsif ((abs($ss_coord[1][0]-$headcoord2)<=$gap)&&(abs($ss_coord[6][0]-$tailcoord1)<=$gap)&&($readstrand eq "-")&&($ss_coord[1][1] ne undef)&&($ss_coord[6][1] ne undef)){
                $circleflag = 1;
                $circleflag = 1;
            }
            elsif ((abs($ss_coord[5][0]-$headcoord2)<=$gap)&&(abs($ss_coord[2][0]-$tailcoord1)<=$gap)&&($readstrand eq "-")&&($ss_coord[5][1] ne undef)&&($ss_coord[2][1] ne undef)){
                $circleflag = 1;
                $circleflag = 1;
            }
            elsif ((abs($ss_coord[5][0]-$headcoord2)<=$gap)&&(abs($ss_coord[2][0]-$tailcoord1)<=$gap)&&($readstrand eq "+")&&($ss_coord[5][1] ne undef)&&($ss_coord[2][1] ne undef)){
...
sub resolveGaps {
    ...
    $command1 = "bedtools getfasta -fi ".$self->{_index}.".fa -bed ".$fhhead." -fo ".$self->{_outdir}."/".$base."_heads.fasta -nameOnly -tab -s";
    $command2 = "bedtools getfasta -fi ".$self->{_index}.".fa -bed ".$fhtail." -fo ".$self->{_outdir}."/".$base."_tails.fasta -nameOnly -tab -s";
